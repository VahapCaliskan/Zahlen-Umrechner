========================================================================
    KONSOLENANWENDUNG: ZahlenUmrechner-Projektübersicht
========================================================================

Diese ZahlenUmrechner-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre ZahlenUmrechner-Anwendung besteht.


ZahlenUmrechner.vcxproj
...
ZahlenUmrechner.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen ZahlenUmrechner.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
